   ...
   console.log("🚀 ~ file: Addgig.js ~ line 18 ~ Addgig ~ description", description)
    ...
    const addPost = async (e) => {
        ...
        if (description === "") {
            ...
            try {
                const res = await client.post("/api/gig/addGig",{userID,name,description});
                console.log(res)
                    ...
                    <View style={{ backgroundColor: "rgba(255, 255, 255, 0.5)", borderRadius: 10, margin: 10 }}>
                        <View style={[styles.container, {
                            ...
                            <View style={{ flex: 2, backgroundColor: "" }}>
                                <TextInput  name="description"  style={styles.textInput} onChangeText={setDescription} placeholder='type your idea'></TextInput>
                            </View>
                        ...
                        <View style={[styles.container, {
                            ...
                            <View style={{ flex: 2, backgroundColor: "", alignItems: 'center' }}>
                                <TouchableOpacity onPress={addPost}>
                                    <Text style={{ color: '#fcbb08' }}>Add Post</Text>
                                </TouchableOpacity>
                            </View>
